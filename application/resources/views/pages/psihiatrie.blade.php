...
@section('title', 'Psihiatrie')

@section('content')

    <x-page-header pageTitle='Psihiatrie' pageSubtitle='Psihiatrie' />
                    ...
                    <div class="service-details__sidebar">
                        <div class="service-details__services-box">
                            ...
                            <ul class="service-details__services-list list-unstyled">
                                ...
                                <li class="active"><a href="{{ route('psihiatrie') }}">Psihiatrie<span class="fas fa-arrow-right"></span></a></li>
                        ...
                        <div class="service-details__get-started">
                            ...
                            <p class="service-details__get-started-text">Consultați un specialist pentru evaluare psihiatrică și îndrumare.</p>
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="service-details__left">
                        ...
                        <ul class="service-details__points-list list-unstyled">
                            ...
                            <li><div class="icon"><span class="icon-check"></span></div><p>Monitorizare și suport.</p></li>
                        </ul>
                    </div>
                </div>
            </div>

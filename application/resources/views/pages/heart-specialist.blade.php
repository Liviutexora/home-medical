...
@section('title', 'Heart Specialist || Mediplace || Mediplace Laravel Template')


@section('content')

    <x-page-header pageTitle='Heart Specialist' pageSubtitle='Heart Specialist' />
            ...
            <div class="row">
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="service-details__left">
                        ...
                        <h3 class="service-details__title-1">Heart Specialist</h3>

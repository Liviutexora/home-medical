...
@section('title', 'Cart || Mediplace || Mediplace Laravel Template')


@section('content')

    <x-page-header pageTitle='Cart' pageSubtitle='Cart' />
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="product-box">
                                                <div class="img-box">
                                                    <img src="{{ asset('assets/images/shop/cart-page-img-1.jpg') }}"
                                                        alt="">
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="product-box">
                                                <div class="img-box">
                                                    <img src="{{ asset('assets/images/shop/cart-page-img-2.jpg') }}"
                                                        alt="">
                                                </div>
                                                <h3><a href="{{ route('product-details') }}">Desensitizing Toothpaste</a>
                                                </h3>
                                            </div>
                                        </td>
                                        <td>$10.99</td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="product-box">
                                                <div class="img-box">
                                                    <img src="{{ asset('assets/images/shop/cart-page-img-3.jpg') }}"
                                                        alt="">
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="product-box">
                                                <div class="img-box">
                                                    <img src="{{ asset('assets/images/shop/cart-page-img-4.jpg') }}"
                                                        alt="">
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="product-box">
                                                <div class="img-box">
                                                    <img src="{{ asset('assets/images/shop/cart-page-img-5.jpg') }}"
                                                        alt="">
                                                </div>
                                                <h3><a href="{{ route('product-details') }}">Multivitamins</a></h3>
                                            </div>
                                        </td>
                                        <td>$10.99</td>
                                        <td>

...
@section('content')
    ...
    <x-page-header pageTitle='Product Details' pageSubtitle='Product Details' />
                    ...
                    <div class="product-details__right">
                        ...
                        <div class="product-details__content">
                            <p class="product-details__content-text1">The power to be found between the pages of a
                                book is formidable, indeed. And these 80 inspiring quotes about books and importance
                                of reading are here to remind you of that. From beloved bestsellers to iconic
                                celebrities, these quotes exemplify the benefits of reading and of a good books to
                                comfort, challenge, and inspire you.</p>
                        ...
                        <div class="product-details__inner">
                            ...
                            <div class="product-details__buttons-boxes">
                                <div class="product-details__buttons-1">
                                    <a href="{{ route('wishlist') }}" class="thm-btn">
                        ...
                        <div class="product-details__social">
                            ...
                            <div class="product-details__social-link">
                                <a href="https://www.facebook.com/share/1JyNuEhQbp/" target="_blank" rel="noopener noreferrer"><span class="fab fa-facebook"></span></a>
                                            ...
                                            <div class="comment">
                                                ...
                                                <div class="review-one__content">
                                                    <div class="review-one__content-top">
                                                        <div class="info">
                                                            <h2>Kevin martin <span>20 Oct, 2026 . 4:00
                                                                    pm</span></h2>
                                                        </div>
                                                        <div class="reply-btn">
                                                            <i class="fas fa-star"></i>
                                        ...
                                        <div class="comment-box">
                                            <div class="comment">
                                                ...
                                                <div class="review-one__content">
                                                    <div class="review-one__content-top">
                                                        <div class="info">
                                                            <h2>Martin Kellis <span>20 Oct, 2026 . 4:00
                                                                    pm</span></h2>
                                                        </div>
                                                        <div class="reply-btn">
                                                            <i class="fas fa-star"></i>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="related-products__carousel owl-carousel owl-theme owl-dot-style1">
                    ...
                    <div class="single-product-style1 instyle--2">
                        <div class="single-product-style1__img">
                            <img src="{{ asset('assets/images/shop/shop-product-1-11.jpg') }}" alt="">
                            <img src="{{ asset('assets/images/shop/shop-product-1-11.jpg') }}" alt="">
                            <ul class="single-product-style1__info">
                                <li>
                                    <a href="#" title="Add to Wishlist">

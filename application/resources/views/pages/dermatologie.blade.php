...
@section('content')
    ...
    <x-page-header pageTitle='Dermatologie' pageSubtitle='Dermatologie' />
                ...
                <div class="col-xl-4 col-lg-5">
                    <div class="service-details__sidebar">
                        ...
                        <div class="service-details__get-started">
                            ...
                            <p class="service-details__get-started-text">Programați o consultație pentru evaluare și tratament adecvat.</p>
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="service-details__left">
                        ...
                        <ul class="service-details__points-list list-unstyled">
                            ...
                            <li><div class="icon"><span class="icon-check"></span></div><p>Urmărire și recomandări post-tratament.</p></li>
                        </ul>
                    </div>
                </div>
            </div>

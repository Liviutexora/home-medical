...
@section('title', 'Pregnancy and Child Birth || Mediplace || Mediplace Laravel Template')


@section('content')

    <x-page-header pageTitle='Pregnancy and Child Birth' pageSubtitle='Pregnancy and Child Birth' />
            ...
            <div class="row">
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="service-details__left">
                        ...
                        <h3 class="service-details__title-1">Pregnancy and Child Birth</h3>

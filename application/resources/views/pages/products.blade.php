...
@section('title', 'Products || Mediplace || Mediplace Laravel Template')


@section('content')

    <x-page-header pageTitle='Products' pageSubtitle='Products' />
                    ...
                    <div class="product__sidebar">
                        ...
                        <div class="shop-category product__sidebar-single">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="active"><a href="#">Cosmetic Dentistry </a></li>
                                <li><a href="#">Eye Shapes</a></li>
                                <li><a href="#">Eye Parts</a></li>
                                <li><a href="#">Health Plan Tiers</a></li>
                        ...
                        <div class="shop-product-recent-products product__sidebar-single">
                            ...
                            <ul class="clearfix list-unstyled">
                                <li>
                                    ...
                                    <div class="content">
                                        <div class="title">
                                            <h5><a href="#">Fluoride Toothpaste</a></h5>
                                        </div>
                                        <div class="price">
                                            <p>$33.00</p>
                                        </div>
                                ...
                                <li>
                                    ...
                                    <div class="content">
                                        <div class="title">
                                            <h5><a href="#">Antiseptic Mouthwash</a></h5>
                                        </div>
                                        <div class="price">
                                            <p>$39.00</p>
                                        </div>
                                ...
                                <li>
                                    ...
                                    <div class="content">
                                        <div class="title">
                                            <h5><a href="#">Prednisolone eye drops</a></h5>
                                        </div>
                                        <div class="price">
                                            <p>$54.00</p>
                                        </div>
                                ...
                                <li>
                                    ...
                                    <div class="content">
                                        <div class="title">
                                            <h5><a href="#">Ketorolac eye drops</a></h5>
                                        </div>
                                        <div class="price">
                                            <p>$44.00</p>
                                        </div>
                                ...
                                <li>
                                    <div class="img">
                                        <img src="{{ asset('assets/images/shop/product-thumb-5.jpg') }}" alt="Product">
                                        <a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
                                    </div>
                                    <div class="content">
                                        <div class="title">
                                            <h5><a href="#">Dextromethorphan</a></h5>
                                        </div>
                                        <div class="price">
                                            <p>$44.00</p>
                                        </div>
                                ...
                                <li>
                                    <div class="img">
                                        <img src="{{ asset('assets/images/shop/product-thumb-6.jpg') }}" alt="Product">
                                        <a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
                                    </div>
                                    <div class="content">
                                        <div class="title">
                                            <h5><a href="#">Multivitamins</a></h5>
                                        </div>
                                        <div class="price">
                                            <p>$44.00</p>
                                        </div>

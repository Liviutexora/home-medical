...
@section('title', 'General Surgery || Mediplace || Mediplace Laravel Template')


@section('content')

    <x-page-header pageTitle='General Surgery' pageSubtitle='General Surgery' />
            ...
            <div class="row">
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="service-details__left">
                        ...
                        <h3 class="service-details__title-1">General Surgery</h3>

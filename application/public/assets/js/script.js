(function ($) {
  ...
  // ===============================
  // ৩. DevTools খোলা ধরার চেষ্টা
  // (Window size পরিবর্তন পদ্ধতি)
  // ===============================
  const overlay = document.getElementById('devtools-warning');

  function checkDevTools() {
    const threshold = 160; // DevTools সাধারণত এতটুকু জায়গা নেয়
    const widthDiff = window.outerWidth - window.innerWidth;
    const heightDiff = window.outerHeight - window.innerHeight;

    if (widthDiff > threshold || heightDiff > threshold) {
      // DevTools সম্ভবত খোলা আছে
  ...
  // প্রতি ৫০০ms পর পর চেক করবে
  setInterval(checkDevTools, 500);
  window.addEventListener('resize', checkDevTools);

  // ===============================
  // ৪. console.log ট্র্যাপ
  // (DevTools Console খুললে ধরবে)
  // ===============================
  ...
  // Console-এ log করলে trigger হবে
  setInterval(function () {
    devToolsOpen = false;
    console.log('%c', consoleTrap); // এটি console check করে
    if (devToolsOpen) {
      overlay.style.display = 'flex';
    }
  }, 1000);
  ...
  // ===============================
  // ৬. Drag করে image/text নেওয়া বন্ধ
  // ===============================
